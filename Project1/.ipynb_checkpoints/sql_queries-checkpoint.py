...
songplay_table_create = (""" CREATE TABLE IF NOT EXISTS songplays (songplays_id SERIAL PRIMARY KEY, time_start bigint, \
...
time_table_create = (""" CREATE TABLE IF NOT EXISTS time (time_start bigint, hour int, day int, weekofyear int, \
